    ...
    <Background color="bg-gray-100 dark:bg-gray-800">
      ...
      <GroupSection>
        <Proposal
          ...
          utility attached, thus, intrinsic value. Btw, the rarity of the traits is generated by quantum randomness.
          "
          description2="We are an 0xagon product, a group of enthusiasts and entrepreneur friends that wish to build for web3.
          "
          description3="$MEN is not just a NFT. It can be negotiated as a vanity item? Yes of course, but it also comes with a few benefits: 
